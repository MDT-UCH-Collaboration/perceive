...
thisdata = [{nightData(nightSig,1)} {dayData(daySig,1)}];
catnames_labels = {'Day','Night'};
coloRS = {cMAP(10,:), cMAP(256,:)};
disp('Test 5: Test two sided violin plots. Japan is being compared.');
figure
vs5 = violinplot(thisdata,catnames_labels,'ViolinColor',coloRS,'ViolinAlpha',{0.5 0.5});
