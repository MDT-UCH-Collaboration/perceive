...
%%
hemiS = {'R','L','L','R','R','R','L','R','R','L','L','R'};
patID = [1, 2, 3, 4, 5, 6, 7, 7, 8, 9,10,10];
overSAT = [true , false , true , true , true, true, true, true, true, true, true,true];
...
jsonNAMEs = {'Report_Json_Session_Report_20210521T115931[1].json',...
             ...
             'Report_Json_Session_Report_20211123T131149.json',...
             'Report_Json_Session_Report_20220104T121534.json',...
             'Report_Json_Session_Report_20220124T081628.json',...
             'Report_Json_Session_Report_20220124T081944.json'};
